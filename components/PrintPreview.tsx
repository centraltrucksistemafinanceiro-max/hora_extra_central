            ...
            {pages.map((pageSummaries, pageIndex) => (
                <div key={pageIndex} className="receipt-page">
                    {pageSummaries.map((summary) => (
                       <div key={summary.employeeId} className="border border-black p-4 flex flex-col text-[10px] leading-tight">
                            <div className="flex justify-between items-center pb-3 border-b border-black mb-1">
                            ...
                            <table className="w-full text-left text-[9px] border-collapse">
                                <thead>
                                    <tr className="border-b border-black">
                                        <th className="py-2 font-bold text-black uppercase tracking-wider">Descrição</th>
                                        <th className="py-2 font-bold text-black uppercase tracking-wider text-right">Horas</th>
                                        <th className="py-2 font-bold text-black uppercase tracking-wider text-right">Valor</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td className="py-2 font-medium text-black">Total de horas extras no período.</td>
                            ...
                            <div className="mt-auto">
                                ...
                                <div className="mt-3 pt-2 border-t border-black text-right">
